...
public class C05_ExplicitWait {
    ...
    public void test01() {
        ...
        WebElement goneYazisi = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='message']")));

                // WebElement goneYazisi=driver.findElement(By.xpath("//*[@id='message']"));
      ...
      WebElement backYazisi=  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[@id='message']")));
