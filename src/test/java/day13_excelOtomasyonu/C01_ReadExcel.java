...
public class C01_ReadExcel {
    ...
    @Test
    public void readExelTestleri() throws IOException {
        ...
        // - 2.satir 4.cell’in afganistan’in baskenti oldugunu test edelim
        String expectedHucre="Kabil";
        String actualHucre=sheet.getRow(1).getCell(3).toString();

        Assert.assertEquals(expectedHucre,actualHucre);
